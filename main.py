...
HEADER = [
    ...
    "‪Jun 1, 2009‬","‪Jul 1, 2009‬","‪Aug 1, 2009‬","‪Sep 1, 2009‬","‪Oct 1, 2009‬","‪Nov 1, 2009‬","‪Dec 1, 2009‬","‪Jan 1, 2010‬","‪Feb 1, 2010‬","‪Mar 1, 2010‬","‪Apr 1, 2010‬",
    ...
    "‪Nov 1, 2015‬","‪Dec 1, 2015‬","‪Jan 1, 2016‬","‪Feb 1, 2016‬","‪Mar 1, 2016‬","‪Apr 1, 2016‬","‪May 1, 2016‬","‪Jun 1, 2016‬","‪Jul 1, 2016‬","‪Aug 1, 2016‬","‪Sep 1, 2016‬",
...
class google_trends:
    ...
    def get_data(self, search, item, url):
        ...
        self.write_to_excel(url, search, dates)
    ...
    def write_to_excel(self, url, search, values):
        workbook = op.load_workbook(self.filename, False)
        ...
        count = 1
        items.append(url)
        print('legth = ', len(values) )
        for v in values:
            count+=1
            items.append(values[v])
